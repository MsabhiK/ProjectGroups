...
<head>
    ...
    <title>Taxi Service - Add New Car</title>
            ...
            <div class="col-lg-8">
                <div class="main-container">
                    <h2 class="section-title">
                        <i class="fas fa-car-side me-2"></i> Add a New Car
                    </h2>
                    
                    <p class="lead mb-4">Register your car to start offering rides to passengers.</p>
                    
                    <!-- Form -->
                    <form:form action="/create-car" method="post" modelAttribute="car" class="needs-validation">
                        <!-- Car Model -->
                        <div class="mb-3">
            ...
            <div class="col-lg-4">
                <div class="main-container">
                    <h3 class="section-title">
                        <i class="fas fa-info-circle me-2"></i> Why Add a Car?
                    </h3>
